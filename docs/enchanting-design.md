...
|----|------|------|-------|--------|
| greater_amulet | Greater Amulet | 3 | 220 | mid caches (gloomfen/desert) |
| master_amulet | Master Amulet | 4 | 360 | deep caches (cinderrift/crypt) |
| mythic_relic | Mythic Relic | 5 | 520 | boss-guaranteed (respects boss-table invariant: `maxAlive 1`, `respawnSec ≥ 600`) |
